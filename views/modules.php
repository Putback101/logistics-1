    ...
    <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 2rem; margin-top: 2rem;">
      ...
      <div style="background: linear-gradient(135deg, #1a202c 0%, #2d3748 100%); border: 2px solid #48bb78; border-radius: 1rem; padding: 2rem; transition: all 0.3s ease; cursor: pointer;" onmouseover="this.style.boxShadow='0 0 30px rgba(72, 187, 120, 0.3)'; this.style.transform='translateY(-5px)';" onmouseout="this.style.boxShadow='none'; this.style.transform='translateY(0)';">
        ...
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 0.75rem;">
          <a href="<?= $base ?>/views/procurement/procurement.php?tab=purchase-orders" style="padding: 0.75rem; background: #2d3748; border: 1px solid #4a5568; border-radius: 0.5rem; color: #e2e8f0; text-decoration: none; text-align: center; font-size: 0.85rem; font-weight: 600; transition: all 0.2s ease;" onmouseover="this.style.background='#48bb78'; this.style.color='#000';" onmouseout="this.style.background='#2d3748'; this.style.color='#e2e8f0';">Purchase Orders</a>
          <a href="<?= $base ?>/views/procurement/procurement.php?tab=suppliers" style="padding: 0.75rem; background: #2d3748; border: 1px solid #4a5568; border-radius: 0.5rem; color: #e2e8f0; text-decoration: none; text-align: center; font-size: 0.85rem; font-weight: 600; transition: all 0.2s ease;" onmouseover="this.style.background='#48bb78'; this.style.color='#000';" onmouseout="this.style.background='#2d3748'; this.style.color='#e2e8f0';">Suppliers</a>
          <a href="<?= $base ?>/views/procurement/procurement.php?tab=budget" style="padding: 0.75rem; background: #2d3748; border: 1px solid #4a5568; border-radius: 0.5rem; color: #e2e8f0; text-decoration: none; text-align: center; font-size: 0.85rem; font-weight: 600; transition: all 0.2s ease;" onmouseover="this.style.background='#48bb78'; this.style.color='#000';" onmouseout="this.style.background='#2d3748'; this.style.color='#e2e8f0';">Budget</a>
          <a href="<?= $base ?>/views/procurement/procurement.php?tab=reports" style="padding: 0.75rem; background: #2d3748; border: 1px solid #4a5568; border-radius: 0.5rem; color: #e2e8f0; text-decoration: none; text-align: center; font-size: 0.85rem; font-weight: 600; transition: all 0.2s ease;" onmouseover="this.style.background='#48bb78'; this.style.color='#000';" onmouseout="this.style.background='#2d3748'; this.style.color='#e2e8f0';">Reports</a>
        </div>
      </div>
      <?php endif; ?>
      ...
      <div style="background: linear-gradient(135deg, #1a202c 0%, #2d3748 100%); border: 2px solid #48bb78; border-radius: 1rem; padding: 2rem; transition: all 0.3s ease; cursor: pointer;" onmouseover="this.style.boxShadow='0 0 30px rgba(72, 187, 120, 0.3)'; this.style.transform='translateY(-5px)';" onmouseout="this.style.boxShadow='none'; this.style.transform='translateY(0)';">
        ...
        <div style="display: grid; grid-template-columns: 1fr; gap: 0.75rem;">
          <a href="<?= $base ?>/views/project/projects.php" style="padding: 0.75rem; background: #2d3748; border: 1px solid #4a5568; border-radius: 0.5rem; color: #e2e8f0; text-decoration: none; text-align: center; font-size: 0.85rem; font-weight: 600; transition: all 0.2s ease;" onmouseover="this.style.background='#48bb78'; this.style.color='#000';" onmouseout="this.style.background='#2d3748'; this.style.color='#e2e8f0';">Project Management</a>
        </div>
      </div>
      <?php endif; ?>
      ...
      <div style="background: linear-gradient(135deg, #1a202c 0%, #2d3748 100%); border: 2px solid #48bb78; border-radius: 1rem; padding: 2rem; transition: all 0.3s ease; cursor: pointer;" onmouseover="this.style.boxShadow='0 0 30px rgba(72, 187, 120, 0.3)'; this.style.transform='translateY(-5px)';" onmouseout="this.style.boxShadow='none'; this.style.transform='translateY(0)';">
        ...
        <div style="display: grid; grid-template-columns: 1fr; gap: 0.75rem;">
          <a href="<?= $base ?>/views/mro/maintenance.php" style="padding: 0.75rem; background: #2d3748; border: 1px solid #4a5568; border-radius: 0.5rem; color: #e2e8f0; text-decoration: none; text-align: center; font-size: 0.85rem; font-weight: 600; transition: all 0.2s ease;" onmouseover="this.style.background='#48bb78'; this.style.color='#000';" onmouseout="this.style.background='#2d3748'; this.style.color='#e2e8f0';">Maintenance</a>
        </div>
      </div>
      <?php endif; ?>
      ...
      <div style="background: linear-gradient(135deg, #1a202c 0%, #2d3748 100%); border: 2px solid #48bb78; border-radius: 1rem; padding: 2rem; transition: all 0.3s ease; cursor: pointer;" onmouseover="this.style.boxShadow='0 0 30px rgba(72, 187, 120, 0.3)'; this.style.transform='translateY(-5px)';" onmouseout="this.style.boxShadow='none'; this.style.transform='translateY(0)';">
        ...
        <div style="display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 0.75rem;">
          <a href="<?= $base ?>/views/warehousing/inventory.php" style="padding: 0.75rem; background: #2d3748; border: 1px solid #4a5568; border-radius: 0.5rem; color: #e2e8f0; text-decoration: none; text-align: center; font-size: 0.85rem; font-weight: 600; transition: all 0.2s ease;" onmouseover="this.style.background='#48bb78'; this.style.color='#000';" onmouseout="this.style.background='#2d3748'; this.style.color='#e2e8f0';">Inventory</a>
          <a href="<?= $base ?>/views/warehousing/inventory.php?tab=inventory" style="padding: 0.75rem; background: #2d3748; border: 1px solid #4a5568; border-radius: 0.5rem; color: #e2e8f0; text-decoration: none; text-align: center; font-size: 0.85rem; font-weight: 600; transition: all 0.2s ease;" onmouseover="this.style.background='#48bb78'; this.style.color='#000';" onmouseout="this.style.background='#2d3748'; this.style.color='#e2e8f0';">Receiving</a>
          <a href="<?= $base ?>/views/warehousing/inventory.php?tab=reconciliation" style="padding: 0.75rem; background: #2d3748; border: 1px solid #4a5568; border-radius: 0.5rem; color: #e2e8f0; text-decoration: none; text-align: center; font-size: 0.85rem; font-weight: 600; transition: all 0.2s ease;" onmouseover="this.style.background='#48bb78'; this.style.color='#000';" onmouseout="this.style.background='#2d3748'; this.style.color='#e2e8f0';">Reconciliation</a>
        </div>
      </div>
      <?php endif; ?>
